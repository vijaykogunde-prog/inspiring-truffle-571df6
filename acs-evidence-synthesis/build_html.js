...
// ---------------------------------------------------------------------
// Citation registry (order of first appearance -> Vancouver number)
// ---------------------------------------------------------------------
const citeOrder = [];
...
// Converts "...text...@@key1,key2@@..." into HTML with <sup> citation markers.
...
function figureHTML(file, caption, widthPct) {
  return `
  <div class="figure">
    <img src="figures/${file}" style="width:${widthPct || 92}%;" />
    <p class="figcaption">${inline(caption)}</p>
  </div>\n`;
}
...
module.exports = { p, h1, h2, li, inline, figureHTML, table, citeOrder, REF, esc };
