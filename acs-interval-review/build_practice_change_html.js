...
const REF = {
  ...
  Sukarna2021: "Sukarna N, Tan PC, Hong JGS, Sulaiman S, Omar SZ. Glycemic control following two regimens of antenatal corticosteroids in mild gestational diabetes: a randomized controlled trial. Arch Gynecol Obstet. 2021;304(2):345-353. PMID: 33452923. DOI: 10.1007/s00404-020-05950-3.",
  Shittu2024: "Shittu KA, Ahmed B, Rabiu KA, Akinlusi F, Akinola OI. Does the use of antenatal corticosteroids reduce respiratory morbidity in babies born in late preterm period? BMC Pregnancy Childbirth. 2024;24(1):334. PMID: 38698318. DOI: 10.1186/s12884-024-06304-6.",
  Elimian2007: "Elimian A, Garry D, Figueroa R, Spitzer A, Wiencek V, Quirk JG. Antenatal betamethasone compared with dexamethasone (Betacode trial): a randomized controlled trial. Obstet Gynecol. 2007;110(1):26-30. PMID: 17601892. DOI: 10.1097/01.AOG.0000268281.36788.81.",
  Oladapo2022interval: "Oladapo OT, Vogel JP, Piaggio G, et al. Effect of dexamethasone on newborn survival at different administration-to-birth intervals: a secondary analysis of the WHO ACTION-I trial. EClinicalMedicine. 2022;53:101744. PMID: 36467459. DOI: 10.1016/j.eclinm.2022.101744.",
};
...
// ---------------------------------------------------------------------
body += `
<div class="kicker">DEPARTMENTAL EVIDENCE SYNTHESIS &amp; PRACTICE PROPOSAL &mdash; UPDATED</div>
...
<p class="corresp">Prepared for departmental review and clinical governance discussion. Author and unit details to be completed by the submitting clinician. This update incorporates two additional randomised trials that directly used the unit's current regimen (Section 2), a corrected time-course for administration-to-birth benefit (Section 5), and a note on a contrasting automated evidence summary reviewed alongside this document (Section 11).</p>
`;
...
body += p("A fair reading of the record shows the regimen has real clinical precedent: a UK protocol paper (Salford, 2003) and a Malaysian trial (2021) both describe this exact schedule as the background ACS practice at their respective institutions.@@Kaushal2003,Hong2021@@ Two further small randomised trials, identified in an update to this document, went further and used the regimen itself as a study arm (Section 2a). None of this changes the central finding: the regimen has persisted in scattered international practice for at least two decades without ever being tested against the guideline-recommended 24-hourly alternative. That longevity is not evidence of equivalence to Regimen B; it is a description of how an untested practice can become routine.");
...
body += table(
  ...
  [
    ...
    ["Trial evidence", "WHO ACTION-I, n=2852", "ASTEROID, n=1346", "2 small RCTs use it directly (n=286 vs placebo; n=60 vs Regimen A) — see 2a. None compare it against Regimen B."],
    ["Guideline status", "WHO/ACOG endorsed", "RCOG primary recommendation", "Not named by any guideline identified"],
  ],
  ["18%", "24%", "24%", "34%"]
);

body += h2("2a. Correction: direct trial evidence for Regimen C does exist — but not the comparison that matters");
body += p("An earlier version of this document stated that zero studies of any design had used the unit's exact regimen. That statement is now corrected. Two randomised trials have been identified that used dexamethasone 12&nbsp;mg IM twice, 12 hours apart, as a study arm in its own right: Shittu and colleagues randomised 286 women to this regimen versus placebo and found a large, statistically robust reduction in neonatal respiratory morbidity (3.8% versus 25.4%, P=.000003), with no significant excess of sepsis, jaundice, or hypoglycaemia.@@Shittu2024@@ Sukarna and colleagues randomised 60 women with gestational diabetes to this regimen versus the WHO four-dose regimen and found favourable, not adverse, secondary neonatal outcomes in the 12-hourly-12mg arm (higher birth weight and gestational age at delivery, fewer maternal hyperglycaemic episodes on day 2).@@Sukarna2021@@");
body += fig("fig5_direct_evidence_regimen_c.png", 96);
body += p("Read honestly, this is genuinely reassuring evidence for the regimen in isolation, and this document says so plainly rather than omitting it to preserve a one-sided case. It does not, however, answer the question this document is about. Neither trial compared the regimen against Regimen B at 24 hours; neither was powered or designed to detect rare harms such as necrotising enterocolitis or intraventricular haemorrhage; and neither reported longer-term neurodevelopmental outcomes. A regimen can look safe against placebo or against a different regimen on the outcomes a small trial happened to measure, and still be inferior to a tested alternative on outcomes those trials were not built to see. The recommendation in Section 8 rests on the interval comparison remaining untested, not on an assertion that the regimen has never been studied at all &mdash; and that comparison is exactly what these two trials, reassuring as they are, do not provide.");
...
body += p("A large secondary analysis of the WHO ACTION-I trial makes the same point on a different timescale and with more statistical power: neonatal mortality benefit continued to increase the longer the administration-to-birth interval was, not levelling off until 13&ndash;14 <em>days</em> after the first dose, before gradually diminishing toward day 28.@@Oladapo2022interval@@ Figure 6 shows this schematically. No mechanism, trial, or dataset identified anywhere in this review &mdash; including in supplementary material specifically checked for this update &mdash; supports a meaningful benefit concentrated around hour 12 to 13 specifically; the real evidence points the opposite way, toward benefit continuing to build over days, far beyond the window a compressed second dose could plausibly influence.");
body += fig("fig6_interval_to_birth_benefit.png", 90);
...
body += p("In fairness, the agent-choice literature is not one-sided in the direction of caution either. An earlier, smaller trial directly comparing the two drugs found the opposite pattern for a different neonatal brain-injury outcome: intraventricular haemorrhage occurred in 5.7% of dexamethasone-exposed infants versus 17.0% of betamethasone-exposed infants (relative risk 2.97, 95% CI 1.22&ndash;7.24), favouring dexamethasone.@@Elimian2007@@ This trial is smaller than ASTEROID and has not been replicated any more than the ASTEROID cerebral palsy signal has; it is included so that this section's account of dexamethasone's long-term and neurological safety record is balanced rather than selectively cautious.");
...
// ---------------------------------------------------------------------
// Section 10: additional source material reviewed for this update
// ---------------------------------------------------------------------
body += h1("10. Additional source material reviewed for this update");
body += p("This update was prepared alongside two further pieces of material the department obtained separately: an automated evidence-summary report (Consensus.app) addressing the same question from a corpus of roughly 50 papers, and an interactive infographic summarising related pharmacology and clinical scenarios. Both were reviewed, and their content was either verified and incorporated above, or checked and found unverifiable and excluded, in line with this document's zero-fabrication standard throughout. This section explains that reconciliation openly rather than silently.");
body += p("The automated report's headline finding &mdash; that 12-hourly dexamethasone dosing shows \"no excess neonatal harm\" &mdash; is not actually in factual conflict with this document once read carefully. Both agree that no head-to-head trial of 12-hourly versus 24-hourly dexamethasone exists. The automated report's reassurance is built from indirect evidence: individual trials of the 12-hourly regimen against placebo or against a different regimen (the same Shittu 2024 and Sukarna 2021 trials discussed in Section 2a), not from a trial comparing it against the 24-hourly alternative this document recommends. Where the two sources differ is emphasis and threshold, not fact: reassuring indirect evidence is not the same as a tested comparison, and this document's recommendation rests on that comparison remaining untested, together with the one relevant interval trial that exists finding a safety signal (Section 4, betamethasone) and an animal study modelling the exact regimen finding a mechanistic signal of concern (Section 7).");
body += p("The infographic contained a mixture of accurate and unverifiable material. Its core trial data for WHO ACTION-I and the Khandelwal necrotising enterocolitis figures matched this document's own independently-verified sources and required no change. Four claims could not be verified and are not used anywhere in this document: a citation to \"Kashanian et al\" reporting a relative risk of 4.7 for neonatal death with compressed dosing, which returned no result in a direct PubMed search; a \"Canadian Neonatal Network dataset of 7,950 infants\" said to show mortality benefit plateauing at 12 hours, which likewise could not be located (Section 5 uses a real, PMID-verified secondary analysis of WHO ACTION-I in its place, which finds benefit continuing to build over days rather than plateauing within hours); a description of UK betamethasone as a depot acetate/phosphate mixture, which contradicts this document's own PubMed-sourced finding that the UK product is a plain, non-depot phosphate ester; and a claim that a mixed betamethasone-then-dexamethasone course is \"100% complete and valid\" on stereoisomer-equivalence grounds, which asserts more certainty than any study identified in this or the prior evidence-synthesis phase of this project supports.");

// ---------------------------------------------------------------------
// Limitations
// ---------------------------------------------------------------------
body += h1("11. Access limitations and honest caveats");
